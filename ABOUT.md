...
$J_X(i) = 1$ nếu $\text{len}(\text{ground\_truth}_X(i)) = 0$ và $\text{len}(\text{prediction}_X(i)) = 0$

$J_X(i) = 0$ nếu $\text{len}(\text{ground\_truth}_X(i)) = 0$ và $\text{len}(\text{prediction}_X(i)) \neq 0$
